...
7,00                        & 0,116 \\\hline               
\end{tabular}
\vspace{1mm} %para añadir espacio
...
\foto{figura.png}{Absorbancia de la muestra problema de Cu EDTA en función del volumen}{grafica2}

Hacemos referencia a la \figref{grafica2} usando el comando \verb|\figref{grafica2}|. De la misma manera con la \tabref{tab:tabla1}
